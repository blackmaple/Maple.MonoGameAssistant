...
namespace Maple.MonoGameAssistant.Core
{
    ...
    internal readonly unsafe partial struct PMONO_CLASS_GET_FIELDS(nint ptr)
    {
        ...
        readonly delegate* unmanaged[Cdecl, SuppressGCTransition]<PMonoClass, PMonoAddress, PMonoField> _func
            = (delegate* unmanaged[Cdecl, SuppressGCTransition]<PMonoClass, PMonoAddress, PMonoField>)ptr;
