...
namespace Maple.MonoGameAssistant.Core
{
    ...
    public readonly unsafe partial struct Ref_MonoDictionary_OptimizationDefault
    {
    ...
    readonly unsafe partial struct Ref_MonoDictionary_OptimizationDefault : IRefMonoDictionary
    {
